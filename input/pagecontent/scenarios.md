Component 3 in the Digital Adaptation Kit (link forthcoming](https://iris.who.int/handle/10665/381616) includes user scenarios, which are narratives that describe how the different personas may interact with each other. The user scenarios are only illustrative and are intended to give an idea of a typical workflow.
